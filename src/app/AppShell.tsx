...
import { BetaTermsModal } from '@/shared/components/BetaTermsModal'
import { AIConsentModal } from '@/shared/components/AIConsentModal'
import { useAIConsent } from '@/shared/hooks/useAIConsent'
import { useBetaTermsAccepted } from '@/shared/hooks/useBetaTermsAccepted'
    ...
    <div className="flex flex-col min-h-screen bg-[var(--color-bg-primary)] w-full">
      ...
      >
        ...
        <div className="flex flex-row items-center gap-2 sm:gap-3 shrink-0">
          ...
          <IconButton size="md" aria-label="Toggle theme" onClick={toggleTheme} className="hidden sm:flex">
            {resolvedTheme === 'dark'
