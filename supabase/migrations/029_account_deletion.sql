-- 029_account_deletion.sql
-- SECURITY DEFINER RPC that deletes all health data for the calling user.
-- Deletion order is FK-safe (child tables before parent tables).
-- Auth credentials are NOT deleted here — the frontend calls signOut() after.
